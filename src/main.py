...
app.add_middleware(
    ...
    allow_headers=["Authorization", "Content-Type", "X-Requested-With", "Accept", "X-Org-ID"],
...
from src.api.v1 import auth, super_admin, org_requests, admin, documents, share_links, chat, limits, email, meetings
